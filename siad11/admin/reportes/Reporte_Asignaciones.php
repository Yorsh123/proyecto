...
class PDF extends FPDF
{
		...
		while ($asignaciones2 = mysqli_fetch_array($asignaciones)) {
			...
			$pdf->Cell(35, 8, mb_convert_encoding($asignaciones2['Docente'], 'ISO-8859-1', 'UTF-8'), 0, 'C');
			$pdf->Cell(35, 8, mb_convert_encoding($asignaciones2['Asignatura'], 'ISO-8859-1', 'UTF-8'), 0, 'C');
