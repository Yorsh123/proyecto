...
class PDF extends FPDF
{
	...
	public $NombreAsignatura;
		function Header()
		{
		    ...
		    $Asignatura = $_POST['asignatura'];
            $asignaciones = mysqli_query($this->conexion, "SELECT NombreAsignatura FROM asignaturas where idAsignatura = '$Asignatura'");
            while($row = mysqli_fetch_row($asignaciones)){
           $this->NombreAsignatura = $row[0];

            }
		     $this->Cell(95,20, $this->NombreAsignatura, 0,0,'R');
			$this->Ln(15);
