...
while ($docentes2 = mysqli_fetch_array($docentes)) {
    ...
    $pdf->Cell(30, 8, mb_convert_encoding($docentes2['NombresDocente'], 'ISO-8859-1', 'UTF-8'), 0);
    $pdf->Cell(30, 8, mb_convert_encoding($docentes2['ApellidosDocente'], 'ISO-8859-1', 'UTF-8'), 0);
    $pdf->Cell(30, 8, $docentes2['CedulaDocente'], 0);
    $pdf->Cell(50, 8, mb_convert_encoding($docentes2['CorreoDocente'], 'ISO-8859-1', 'UTF-8'), 0);
    $pdf->Cell(20, 8, $docentes2['CelularDocente'], 0);
    $pdf->Cell(20, 8, $docentes2['TelefonoDocente'], 0);
    $pdf->Ln(5);

    $texto = mb_convert_encoding('Lorem Ipsum …...', 'ISO-8859-1', 'UTF-8');
}
